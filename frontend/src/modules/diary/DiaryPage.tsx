  ...
  return (
    <section className="diary-page">
      ...
      <aside className="diary-shelf-placeholder">
        <span>Скоро</span>
        <h2>Винная полка</h2>
        <p>Сохраняй вина, которые хочется попробовать, вспомнить или купить снова. Полка работает отдельно от заметок, но может быть связана с ними.</p>
        <Link className="primary-action" to="/diary/shelf">
          Открыть винную полку
        </Link>
      </aside>
